default:
	...
	g++ -m64 -march=native -mtune=native -mssse3 -Wall -Wextra -Wno-deprecated-copy -Ofast -ftree-vectorize -o hash/ripemd160.o -ftree-vectorize -flto -c hash/ripemd160.cpp
